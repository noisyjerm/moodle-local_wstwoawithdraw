...
$string['cohortnotfound']    = 'Cohort {$a} was not found.';
...
$string['notincohort']      = 'Student {$a->user} was not found in cohort {$a->cohort}.';
...
$string['studentnotfound']  = 'No student was found with id {$a}.';
